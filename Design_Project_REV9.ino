...
const int ci_UltrasonicT_Echo = 8; //echo
const int ci_UltrasonicT_Trig = 9; //trig
...
const int ci_Right_Motor = A0;
const int ci_Left_Motor = A1;
...
volatile unsigned int  ui_Robot_State_Index = 0;
//0123456789ABCDEF
...
void loop()
{
  ...
  switch (ui_Robot_State_Index)
  {
    ...
    case 4: //place cube under pyramid
      {
        pyramidFound();
        break;
      }
    ...
    case 6:    //Calibrate motor straightness after 3 seconds.
      {
        if (bt_3_S_Time_Up)
        {
...
void keepDistance ()
{
  ...
  else if (distanceFront > (ci_distance_from_wall + 3)) //too far from wall
    veerRight();
