...
void keepDistance ()
{
  ...
  if ((distanceBack + distanceFront)/2 > (ci_distance_from_wall + 3)) //too far from wall
    veerRight();

  else if((distanceBack + distanceFront)/2 < (ci_distance_from_wall + 3)) //too close to wall
    veerLeft();
